...
STRATEGY_META: dict[str, dict[str, str]] = {
    ...
    "small_value": {
        "label": "小市值多因子轮动",
        "status": "研究",
        "desc": "RESEARCH-015胜出H5：避雷池(市值15-60亿/价3-25元/流动性/炒作剔除)→PIT财务过滤(营收>3亿且盈利)→市值最小60只内二级因子打分(市值40+反转25+换手20+ROE15)→Top10等权月度轮动，1月与4月20日后空仓。全成本实证2019-2026：CAGR 30.9%/Sharpe 1.18/超额同池等权+12.8pp，但MDD -35%不满足-20%红线，仅限回测研究。依赖data/factors基本面数据。",
    },
}
