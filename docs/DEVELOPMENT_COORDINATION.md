...
| DATA-001 | 内容哈希数据快照 | 数据工程 | 0-1 | P0 | 无 | 历史修订会改变 snapshot_id |
| RULE-001 | SecurityMaster 与 RuleBook | 数据工程 + 后端交易 | 1 | P0 | DATA-001 | 历史日期规则测试通过 |
...
| BROKER-001 | PaperBroker 持久化与恢复 | 后端交易 | 4 | P1 | OMS-001 | 故障注入通过 |
