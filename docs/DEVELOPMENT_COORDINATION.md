...
| RESEARCH-002 | 新因子与组合优化 | 量化研究 | 3 | P1 | RESEARCH-001 | ⚠️ 2026-09-01 第一轮研究闭环完成但出口未通过：实现财报质量、涨停/追板拥挤、市场广度、龙虎榜与公告事件合同；2023+ 事件因子 IC 保持正向，但混入 `lowvol_indz` 的首次独立 OOS 退化；纯事件候选统一门禁因 2x 成本 CAGR、1x Sharpe、超额三项 FAIL，未改 live allowlist。详见 `docs/RESEARCH_002_A股事件与财报因子研究_2026-09-01.md`；待完整 PIT 财报/证券状态/事件数据和新未见样本后再验 |
